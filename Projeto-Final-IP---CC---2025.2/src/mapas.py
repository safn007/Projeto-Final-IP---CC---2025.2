...
class Mapas:
    def __init__(self, largura, altura):
        ...
        self.mapa1 = pygame.image.load(os.path.join (images_path_base, "mapa_1.png"))
        self.mapa2 = pygame.image.load(os.path.join (images_path_base, "mapa_2.png"))
        self.mapa3 = pygame.image.load(os.path.join (images_path_base, "mapa_3.png"))
